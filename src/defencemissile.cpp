...
Defencemissile::Defencemissile(float x, float y, float z, color_t color) {
...
void Defencemissile::draw(glm::mat4 VP) {
...
void Defencemissile::set_position(float x, float y, float z) {
	this->position = glm::vec3(x, y, z);
}

void Defencemissile::move(int flag) {
	if(flag){
