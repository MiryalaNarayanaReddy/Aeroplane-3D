...
Defencetower::Defencetower(float x, float y, float z, color_t color) {
...
void Defencetower::draw(glm::mat4 VP) {
...
void Defencetower::set_position(float x, float y, float z) {
	this->position = glm::vec3(x, y, z);
}
