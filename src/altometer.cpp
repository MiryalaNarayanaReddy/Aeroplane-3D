...
Altometer::Altometer(float x, float y, float z, color_t color1, color_t color2, color_t color3) {
...
void Altometer::draw(glm::mat4 VP, float percentage) {
...
void Altometer::set_position(float x, float y, float z) {
	this->position = glm::vec3(x, y, z);
}
